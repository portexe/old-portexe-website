var Zepto = function() {
    ...
    function d(t, e, n) {
        for (E in e) n && (o(e[E]) || X(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), X(e[E]) && !X(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== x && (t[E] = e[E])
    }
    ...
    return Q.matches = function(t, e) {
        ...
        var r, i = t.parentNode,
            o = !i;
        return o && (i = Y).appendChild(t), r = ~Q.qsa(i, e).indexOf(t), o && Y.removeChild(t), r
    }, T = function(t) {
        ...
        var r, i, s;
        return D.test(t) && (r = S(P.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(I, "<$1></$2>")), e === x && (e = _.test(t) && RegExp.$1), e in $ || (e = "*"), s = $[e], s.innerHTML = "" + t, r = S.each(N.call(s.childNodes), function() {
            s.removeChild(this)
        ...
        if (!t) return Q.Z();
        if ("string" == typeof t)
            if ("<" == (t = t.trim())[0] && _.test(t)) r = Q.fragment(t, RegExp.$1, n), t = null;
            else {
                if (n !== x) return S(n).find(t);
                r = Q.qsa(P, t)
            }
        else {
            if (e(t)) return S(P).ready(t);
            if (Q.isZ(t)) return t;
            if (X(t)) r = a(t);
            else if (i(t)) r = [t], t = null;
            else if (_.test(t)) r = Q.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== x) return S(n).find(t);
                r = Q.qsa(P, t)
            }
        ...
        var n, i = "#" == e[0],
            ...
            s = i || o ? e.slice(1) : e,
            a = U.test(s);
        return r(t) && a && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : N.call(a && !i ? o ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e))
        ...
        for (; e && (e = e.parentNode);)
            if (e === t) return !0;
        return !1
    }, S.type = t, S.isFunction = e, S.isWindow = n, S.isArray = X, S.isPlainObject = o, S.isEmptyObject = function(t) {
        var e;
        for (e in t) return !1;
        return !0
        ...
        ready: function(t) {
            return J.test(P.readyState) && P.body ? t(S) : P.addEventListener("DOMContentLoaded", function() {
                t(S)
            }, !1), this
        },
        get: function(t) {
        ...
        filter: function(t) {
            return e(t) ? this.not(this.not(t)) : S(L.call(this, function(e) {
        ...
        not: function(t) {
            ...
            if (e(t) && t.call !== x) this.each(function(e) {
                ...
                var r = "string" == typeof t ? this.filter(t) : s(t) && e(t.item) ? N.call(t) : S(t);
        ...
        closest: function(t, e) {
            var n = this[0],
                i = !1;
            for ("object" == typeof t && (i = S(t)); n && !(i ? i.indexOf(n) >= 0 : Q.matches(n, t));) n = n !== e && !r(n) && n.parentNode;
            return S(n)
        },
        parents: function(t) {
        ...
        css: function(e, n) {
            ...
            var s = "";
            if ("string" == t(e)) n || 0 === n ? s = u(e) + ":" + f(e, n) : this.each(function() {
                this.style.removeProperty(u(e))
            });
            else
                for (E in e) e[E] || 0 === e[E] ? s += u(E) + ":" + f(E, e[E]) + ";" : this.each(function() {
                    this.style.removeProperty(u(E))
                });
            return this.each(function() {
        ...
        S.fn[e] = function() {
            var e, i, o = S.map(arguments, function(n) {
                    return "object" == (e = t(n)) || "array" == e || null == n ? n : Q.fragment(n)
                }),
                s = this.length > 1;
            return o.length < 1 ? this : this.each(function(t, e) {
                i = r ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null;
                var a = S.contains(P.documentElement, i);
    ...
    }), Q.Z.prototype = S.fn, Q.uniq = j, Q.deserializeValue = b, S.zepto = Q, S
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    function(t) {
        ...
        function u(e, n) {
            ...
            }), (n.defaultPrevented !== f ? n.defaultPrevented : "returnValue" in n ? !1 === n.returnValue : n.getPreventDefault && n.getPreventDefault()) && (e.isDefaultPrevented = x)), e
        }
        ...
        t.fn.delegate = function(t, e, n) {
            ...
            return this.each(function(s, a) {
                (i = l(m(e) ? t.Event(e) : e))._args = r, i.target = a, t.each(n(a, e.type || e), function(t, e) {
    ...
    function(t) {
        ...
        function s(t, e, r, i) {
            var o = r.context,
                s = "success";
            r.success.call(o, t, s, e), i && i.resolveWith(o, [t, s, e]), n(r, o, "ajaxSuccess", [e, r, t]), c(s, e, r)
        }

        function a(t, e, r, i, o) {
            var s = i.context;
            i.error.call(s, r, e, t), o && o.rejectWith(s, [r, e, t]), n(i, s, "ajaxError", [r, i, t || e]), c(e, r, i)
        }
        ...
        function d(e, n, r, i) {
            ...
            t.each(n, function(n, c) {
                o = t.type(c), i && (n = r ? i : i + "[" + (a || "object" == o || "array" == o ? n : "") + "]"), !i && s ? e.add(c.name, c.value) : "array" == o || !r && "object" == o ? d(e, c, r, n) : e.add(n, c)
            })
        }
        var m, v, g = 0,
            y = window.document,
        ...
        T.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            return n && n.promise(p), t(l).on("load error", function(o, c) {
                clearTimeout(i), t(l).off().remove(), "error" != o.type && r ? s(r[0], p, e, n) : a(null, c || "error", p, e, n), window[u] = f, r && t.isFunction(f) && f(r[0]), f = r = void 0
            ...
            var p = i.dataType,
                d = /\?.+=\?/.test(i.url);
            if (d && (p = "jsonp"), !1 !== i.cache && (e && !0 === e.cache || "script" != p && "jsonp" != p) || (i.url = f(i.url, "_=" + Date.now())), "jsonp" == p) return d || (i.url = f(i.url, i.jsonp ? i.jsonp + "=?" : !1 === i.jsonp ? "" : "callback=?")), t.ajaxJSONP(i, c);
            var g, b = i.accepts[p],
                w = {},
                x = function(t, e) {
                    w[t.toLowerCase()] = [t, e]
            ...
            if (c && c.promise(S), i.crossDomain || x("X-Requested-With", "XMLHttpRequest"), x("Accept", b || "*/*"), (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(b)), (i.contentType || !1 !== i.contentType && i.data && "GET" != i.type.toUpperCase()) && x("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
                for (v in i.headers) x(v, i.headers[v]);
            if (S.setRequestHeader = x, S.onreadystatechange = function() {
                    if (4 == S.readyState) {
                        ...
                        if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == E) {
                            p = p || l(i.mimeType || S.getResponseHeader("content-type")), e = S.responseText;
                            try {
                                "script" == p ? (0, eval)(e) : "xml" == p ? e = S.responseXML : "json" == p && (e = C.test(e) ? null : t.parseJSON(e))
                            } catch (t) {
                                n = t
                            }
                            n ? a(n, "parsererror", S, i, c) : s(e, S, i, c)
                        } else a(S.statusText || null, S.status ? "error" : "abort", S, i, c)
                    }
                }, !1 === o(S, i)) return S.abort(), a(null, "abort", S, i, c), S;
            if (i.xhrFields)
                for (v in i.xhrFields) S[v] = i.xhrFields[v];
            var O = !("async" in i) || i.async;
            S.open(i.type, i.url, O, i.username, i.password);
            for (v in w) j.apply(S, w[v]);
            return i.timeout > 0 && (g = setTimeout(function() {
                S.onreadystatechange = u, S.abort(), a(null, "timeout", S, i, c)
    ...
    function() {
        ...
        var t = document.querySelector(".post-content"),
            e = document.querySelector(".progress-bar");
        if (t && e) {
            var n = 0,
                r = t.scrollHeight,
                i = e.querySelector(".completed"),
                o = e.querySelector(".remaining"),
                s = e.querySelector(".time-completed"),
                a = e.querySelector(".time-remaining");
            document.addEventListener("scroll", function() {
                var t = window.pageYOffset || document.documentElement.scrollTop;
                if (e.style.bottom = t > n ? "0%" : "-100%", t <= r) {
                    var c = t / r,
                        u = (100 * c).toFixed(2),
                        l = 100 - parseFloat(u);
                    i.style.width = u.toString() + "%", o.style.width = l.toString() + "%";
                    var f = 60 * parseInt(e.getAttribute("data-minutes")),
                        h = parseInt(c * f),
                        p = parseInt(h / 60),
                        d = parseInt(60 * (h / 60 - p)),
                        m = f - h,
                        v = parseInt(m / 60),
                        g = parseInt(60 * (m / 60 - v));
                    p = p < 10 ? "0" + p : p, d = d < 10 ? "0" + d : d, v = v < 10 ? "0" + v : v, g = g < 10 ? "0" + g : g, s.innerText = p + ":" + d, a.innerText = v + ":" + g
                } else {
                    i.style.width = "100%", o.style.width = "0%";
                    var y = parseInt(e.getAttribute("data-minutes"));
                    y = y < 10 ? "0" + y : y, s.innerText = "00:00", a.innerText = y + ":00"
                }
                n = t
            })
        }
    ...
    function(t) {
        ...
        function n() {
            return t.pageYOffset || c.scrollTop
        }
        ...
        function a(t, e) {
            this.el = t, this.options = o(this.defaults, e), this._init()
        }
        var c = t.document.documentElement;
        a.prototype = {
            defaults: {
                minDuration: 0,
                maxDuration: 0,
            ...
            _init: function() {
                ...
                e.items.forEach(function(t, n) {
                    i(t) && (e._checkTotalRendered(), classie.add(t, "shown"), s(t.querySelector(".preload")))
                }), t.addEventListener("scroll", function() {
                    e._onScrollFn()
                }, !1), t.addEventListener("resize", function() {
                    e._resizeHandler()
                }, !1)
            },
            ...
            _scrollPage: function() {
                ...
                this.items.forEach(function(r, o) {
                    classie.has(r, "shown") || classie.has(r, "animate") || !i(r, t.options.viewportFactor) || setTimeout(function() {
                        var i = n() + e() / 2;
                        if (t.el.style.WebkitPerspectiveOrigin = "50% " + i + "px", t.el.style.MozPerspectiveOrigin = "50% " + i + "px", t.el.style.perspectiveOrigin = "50% " + i + "px", t._checkTotalRendered(), t.options.minDuration && t.options.maxDuration) {
                            var o = Math.random() * (t.options.maxDuration - t.options.minDuration) + t.options.minDuration + "s";
                            r.style.WebkitAnimationDuration = o, r.style.MozAnimationDuration = o, r.style.animationDuration = o
                        }
                        classie.add(r, "animate"), s(r.querySelector(".preload"))
                    }, 25)
                }), this.didScroll = !1
            },
            ...
            _checkTotalRendered: function() {
                ++this.itemsRenderedCount === this.itemsCount && t.removeEventListener("scroll", this._onScrollFn)
            }
        }, t.AnimOnScroll = a
    }(window),
    function(t) {
        t.fn.simpleJekyllSearch = function(e) {
            ...
            function r(e) {
                ...
                return t.each(c, function(t, r) {
                    for (var t = 0; t < a.length; t++) void 0 !== r[a[t]] && -1 !== r[a[t]].toLowerCase().indexOf(e.toLowerCase()) && (n.push(r), t = a.length)
                }), n
            }

            function i(e) {
                o(), l.append(t(s.searchResultsTitle)), e.length ? t.each(e, function(e, n) {
                    if (e < s.limit) {
            ...
            s.jsonFile.length && l.length && t.ajax({
                ...
                error: function(t, e, n) {
                    console.log("***ERROR in simpleJekyllSearch.js***"), console.log(t), console.log(e), console.log(n)
                }
            })
        }
    }(Zepto),
    function(t, e) {
        ...
        "use strict";
        var e, n, r, i, o = {},
            s = "querySelector" in document && "addEventListener" in t,
            a = {
            ...
            c = function() {
                ...
                for (; n < r; n++) ! function(n) {
                    for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e && "[object Object]" === Object.prototype.toString.call(n[r]) ? t[r] = c(!0, t[r], n[r]) : t[r] = n[r])
                }(arguments[n]);
                return t
            },
            u = function(t) {
            ...
            l = function(t, e) {
                var n, r, i = e.charAt(0),
                    o = "classList" in document.documentElement;
                for ("[" === i && (n = (e = e.substr(1, e.length - 2)).split("=")).length > 1 && (r = !0, n[1] = n[1].replace(/"/g, "").replace(/'/g, "")); t && t !== document; t = t.parentNode) {
                    if ("." === i)
                        if (o) {
            ...
            f = function(t) {
                for (var e, n = String(t), r = n.length, i = -1, o = "", s = n.charCodeAt(0); ++i < r;) {
                    ...
                    e >= 1 && e <= 31 || 127 == e || 0 === i && e >= 48 && e <= 57 || 1 === i && e >= 48 && e <= 57 && 45 === s ? o += "\\" + e.toString(16) + " " : o += e >= 128 || 45 === e || 95 === e || e >= 48 && e <= 57 || e >= 65 && e <= 90 || e >= 97 && e <= 122 ? n.charAt(i) : "\\" + n.charAt(i)
                }
                return o
            },
            h = function(t, e) {
        ...
        o.animateScroll = function(e, n, o) {
            var s = m(e ? e.getAttribute("data-options") : null),
                u = c(u || a, o || {}, s),
                l = "#" === (n = "#" + f(n.substr(1))) ? t.document.documentElement : t.document.querySelector(n),
                y = t.pageYOffset;
            r || (r = t.document.querySelector(u.selectorHeader)), i || (i = g(r));
            var b, w, x, E = p(l, i, parseInt(u.offset, 10)),
                S = E - y,
                C = d(),
                T = 0;
            v(n, u.updateURL);
            var j = function(r, i, o) {
                    var s = t.pageYOffset;
                    (r == i || s == i || t.innerHeight + s >= C) && (clearInterval(o), l.focus(), u.callback(e, n))
                },
                O = function() {
                    w = (T += 16) / parseInt(u.speed, 10), w = w > 1 ? 1 : w, x = y + S * h(u.easing, w), t.scrollTo(0, Math.floor(x)), j(x, E, b)
                };
            0 === t.pageYOffset && t.scrollTo(0, 0), b = setInterval(O, 16)
        };
        var y = function(t) {
                var n = l(t.target, e.selector);
                n && "a" === n.tagName.toLowerCase() && (t.preventDefault(), o.animateScroll(n, n.hash, e))
            },
            b = function(t) {
        ...
        return o.destroy = function() {
            e && (t.document.removeEventListener("click", y, !1), t.removeEventListener("resize", b, !1), e = null, n = null, r = null, i = null)
        }, o.init = function(n) {
            s && (o.destroy(), e = c(a, n || {}), r = t.document.querySelector(e.selectorHeader), i = g(r), t.document.addEventListener("click", y, !1), r && t.addEventListener("resize", b, !1))
        }, o
    }),
    function() {
        for (var t = document.links, e = 0, n = t.length; e < n; e++) t[e].hostname != window.location.hostname && (t[e].target = "_blank")
    }(),
    function(t, e, n) {
        function r() {
            t(".search-wrapper").toggleClass("active"), i.searchform.toggleClass("active"), i.canvas.removeClass("search-overlay")
        }
        t("#menu").click(function() {
            t("body").addClass("push-menu-to-right"), t("#sidebar").addClass("open"), t(".overlay").addClass("show")
        }), t("#mask").click(function() {
            t("body").removeClass("push-menu-to-right"), t("#sidebar").removeClass("open"), t(".overlay").removeClass("show")
        });
        var i = {
        ...
        i.dothis.on("click", function() {
            t(".search-wrapper").toggleClass("active"), i.searchform.toggleClass("active"), i.searchform.find("input").focus(), i.canvas.toggleClass("search-overlay"), t(".search-field").simpleJekyllSearch()
        }), i.close.on("click", r), document.addEventListener("keyup", function(e) {
